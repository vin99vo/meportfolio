...
import { ReactNode, type RefObject, type FC } from 'react'
import { ExtraCurricularSection } from './styles'
...
export const ExtraCurricular = forwardRef<HTMLElement, ExtraCurricularProps>(
  ({ passedID }, ref) => {
    const contents = [
      {
    ...
    return (
      <ExtraCurricularSection id={passedID} ref={ref}>
        <Card>
